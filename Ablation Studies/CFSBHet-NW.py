...
if __name__ == '__main__':
    ...
    threshold_list = [threshold_for_beauty, threshold_for_fashion, threshold_for_movie, threshold_for_music, threshold_for_toys]
    ...
    for df_path, meta_df_path, threshold in zip(df_path_list, meta_df_path_list, threshold_list):
        ...
        if 'beauty' in df_path:
            output_path = f'../../Datasets/SBERT+HeteroGNN+InteractionFilter_hidden_channels={hidden_channels}_{args.rec_pre_trained_data}.xlsx'
        else:
            output_path = f'../../Datasets/SBERT+HeteroGNN+InteractionFilter_hidden_channels={hidden_channels}_{args.rec_pre_trained_data}.xlsx'
    ...
    '''
    Dataset: ../../Datasets/beauty.pkl RMSE: 1.3110140831365014 MAE: 0.9888189619662675 Hidden channels: 16 threshold: 5
    [1.3277500146036005, 1.3333753397361847, 1.3266046154469477, 1.2506222523862716, 1.3167181935095027]
    [0.9950494036306741, 0.9925142553334239, 0.9934837014522943, 0.965789646354454, 0.9972578030604915]
    
    Dataset: ../../Datasets/fashion.pkl RMSE: 1.481399932011723 MAE: 1.0593884505710438 Hidden channels: 16 threshold: 5
    [1.4688378986540296, 1.4783016934670852, 1.4959686506200793, 1.46768456511323, 1.4962068522041918]
    [1.056107792100606, 1.0586056576487937, 1.0685749528726725, 1.0521578301761345, 1.0614960200570132]
        
    Dataset: ../../Datasets/Musical_Instruments.pkl RMSE: 1.1629516195429883 MAE: 0.9232028135031485 Hidden channels: 16 threshold: 5
    [1.1454440103065053, 1.1543686383241243, 1.1586307261551185, 1.1937223407069848, 1.1625923822222086]
    [0.9150939676311692, 0.9212564849961703, 0.9219100722763237, 0.9341638026426827, 0.9235897399693964]
    
    Dataset: ../../Datasets/Movies_and_TV.pkl RMSE: 1.0767775456399122 MAE: 0.8777088078054274 Hidden channels: 16 threshold: 5
    [1.0735390132673222, 1.0631185783760895, 1.0685619112821325, 1.0939269663499076, 1.08474125892411]
    [0.8791782186082947, 0.8744546622497357, 0.8725938837064745, 0.8835560052130695, 0.8787612692495621]

    Dataset: ../../Datasets/Toys_and_Games.pkl RMSE: 1.1232208868454576 MAE: 0.9036546423905314 Hidden channels: 16 threshold: 5
    [1.1195021826663154, 1.1173842377317702, 1.1262975194943392, 1.1403849308002028, 1.1125355635346608]
    [0.9045714182118757, 0.8982786185384796, 0.9069307918352638, 0.9114180548965198, 0.8970743284705187]
    '''
